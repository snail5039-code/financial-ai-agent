import type { DecisionReviewData } from "../types/dashboard";

export const decisionReview: DecisionReviewData = {
  title: "사용자 승인 이력·결정 회고",
  generatedAt: "2026-08-28T10:20:00+09:00",
  dataAsOf: "2026-08-27T10:20:00+09:00",
  isMock: true,
  paperOnly: true,
  executed: false,
