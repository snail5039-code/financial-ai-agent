...
export const evidencePackets: EvidencePacket[] = [
  {
    ...
    expiresAt: "14:42",
    generatedAt: "2026-08-27T14:31:00+09:00",
    dataAsOf: "2026-08-27T14:31:00+09:00",
    isMock: true,
    paperOnly: true,
    externalConnections: 0,
    executed: false,
    ...
    summary: "승인 대기 DEC-1042와 연결된 화면용 근거 패킷입니다. 계산, 정책, 비용, 출처, 리스크, 역할 확인, 사용자 승인 경계를 한 화면에서 검토합니다.",
    calculation: {
      formula: "10주 x 71,200원",
      result: "712,000원",
    ...
    risk: {
      concentration: "삼성전자 목표 비중 7.20% 예시",
      volatility: "최근 변동성 사용자 기준 근접 예시",
      invalidCondition: "실제 시세, 공시, 계좌 검증이 필요해지면 이 패킷은 무효"
    },
    roles: [
      { role: "분석 에이전트", check: "후보 산출", tone: "info" },
      { role: "검증 에이전트", check: "계산 형식 일치", tone: "success" },
      { role: "정책 감시", check: "조건부 한도 예시", tone: "warning" },
      { role: "관리자", check: "사용자 승인 전 대기", tone: "info" }
    ],
    approvalBoundary: "이 화면은 승인 전 검토용입니다. 모의승인 또는 반려는 로컬 화면 상태만 바꾸며 실제 금융 행동, 계좌 요청, 주문 생성, 체결은 발생하지 않습니다.",
    items: [
      {
        title: "계산 재현성",
        status: "확인",
        ...
        detail: "10주 x 71,200원 = 712,000원으로 승인 대기 화면의 DEC-1042 최대 금액과 일치합니다."
      },
      {
        title: "정책 한도",
        status: "주의",
