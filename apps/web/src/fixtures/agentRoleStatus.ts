import type { AgentRoleStatusData } from "../types/dashboard";

export const agentRoleStatus: AgentRoleStatusData = {
  title: "에이전트별 역할 상태판",
  generatedAt: "2026-08-28T11:40:00+09:00",
  dataAsOf: "2026-08-27T11:40:00+09:00",
  isMock: true,
  paperOnly: true,
  executed: false,
  externalConnections: 0,
  safetyCopy: "모의투자 · 화면 검토용 가상 예시 · 실제 주문·체결 아님 · 실제 계좌·API·DB 미연결 · 실제 AI 실행 또는 외부 에이전트 실행 아님 · 외부 요청 0건",
  roles: [
    {
      id: "proposer",
      role: "제안자",
      ...
      wait: "검증자 출처 신뢰도 점검 대기",
      approval: false,
      history: "DEC-1043 반려 후 근거 보강",
      decision: "DEC-1056",
    ...
    },
    {
      ...
      wait: "공시 원문 미연결 표시 유지",
      approval: false,
      history: "DEC-1043 출처 신뢰도 보강 요청",
      decision: "DEC-1043",
    ...
    },
    {
      ...
      wait: "종목 집중도 조건을 사용자 확인 항목으로 남김",
      approval: true,
      history: "DEC-1052 비용 영향 재검토",
      decision: "DEC-1052",
